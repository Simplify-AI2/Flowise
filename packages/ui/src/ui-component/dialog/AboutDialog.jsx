                            ...
                            <TableBody>
                                <TableRow sx={{ '&:last-child td, &:last-child th': { border: 0 } }}>
                                    <TableCell component='th' scope='row'>
                                        SimplifyAI is all about making smart automation simple. We&rsquo;ve built a platform that lets you
                                        ...
                                        you, without you, without you, without needing to be a coding whiz. <p></p>Current version:
                                        SimplifyAI v1.0
                                    </TableCell>
                                </TableRow>
                            </TableBody>
